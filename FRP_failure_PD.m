%FRP failure analysis cosidering partial degradation
...
%Ply properties 
n = 8;       %Number of layer
E1 = [38.6e9, 38.6e9, 38.6e9, 38.6e9, 38.6e9, 38.6e9, 38.6e9, 38.6e9];    % E (long.)
E2 = [8.27e9, 8.27e9, 8.27e9, 8.27e9, 8.27e9, 8.27e9, 8.27e9, 8.27e9];    % E Trans.
nu12 = [0.28, 0.28, 0.28, 0.28, 0.28, 0.28, 0.28, 0.28];                  %Major poissons ratio
G12 = [4.14e9, 4.14e9, 4.14e9, 4.14e9, 4.14e9, 4.14e9, 4.14e9, 4.14e9];   % G 
...
S1Tu = [1062e6, 1062e6, 1062e6, 1062e6, 1062e6, 1062e6, 1062e6, 1062e6];  %sigma long. tensile
S1Cu = [610e6, 610e6, 610e6, 610e6, 610e6, 610e6, 610e6, 610e6];          % sigma comp. long.
S2Tu = [31e6, 31e6, 31e6, 31e6, 31e6, 31e6, 31e6, 31e6];                  % sigma trans tensile
S2Cu = [118e6, 118e6, 118e6, 118e6, 118e6, 118e6, 118e6, 118e6];          % sigma trans. com.
T12u = [72e6, 72e6, 72e6, 72e6, 72e6, 72e6, 72e6, 72e6];                  % tau

a1 = [8.6e-6, 8.6e-6, 8.6e-6, 8.6e-6, 8.6e-6, 8.6e-6, 8.6e-6, 8.6e-6];    %alphaT long. in m/m/deg C 
a2 = [22.1e-6, 22.1e-6, 22.1e-6, 22.1e-6, 22.1e-6, 22.1e-6, 22.1e-6, 22.1e-6];   %alphaT trans. in m/m/deg C 
b1 = [0, 0, 0, 0, 0, 0, 0, 0];                                            % Beta long. in m/m/deg C 
b2 = [0, 0, 0, 0, 0, 0, 0, 0];                                            % Beta trans. in m/m/deg C 
...
theta = [0; 45; -45; 90; 90; -45; 45; 0];                   %Orientatation
t = [0.125e-3; 0.125e-3; 0.125e-3; 0.125e-3; 0.125e-3; 0.125e-3; 0.125e-3; 0.125e-3];   %Z-value
